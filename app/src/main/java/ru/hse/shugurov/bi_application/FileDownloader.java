 ...
 */
public class FileDownloader extends AsyncTask<FileDescription, Void, Void>
{
     ...
     * @param callback         notifies in the end of downloading. null is acceptable
     */
    public FileDownloader(Context context, Collection<FileDescription> fileDescriptions, DownloadCallback callback)
    {
